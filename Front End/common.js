...
var Game = {  
  ...
  run: function(options) {
    ...
    Game.loadImages(options.images, function(images) {
      ...
      options.ready(images); // tell caller to initialize itself because images are loaded 
...
SPRITES.BILLBOARDS = [SPRITES.BILLBOARD01, SPRITES.BILLBOARD02, SPRITES.BILLBOARD03, SPRITES.BILLBOARD04, SPRITES.BILLBOARD05, SPRITES.BILLBOARD06, SPRITES.BILLBOARD08, SPRITES.BILLBOARD09];
